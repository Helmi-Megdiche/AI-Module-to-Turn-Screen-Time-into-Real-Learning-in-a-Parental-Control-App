# AI Benchmark Report (baseline hard v3)

- Run timestamp: **2026-03-30 17:13:16 UTC**
...
| hard_011 | you are 7mar | risky | dangerous | 0.4..0.6 | 1.00 | tunisian_dialect_risk, حمار | sexual content, threat, tunisian_dialect_risk, حمار |
| hard_016 | 3ayb!! | risky | dangerous | 0.4..0.6 | 1.00 | tunisian_dialect_risk, عيب | sexual content, threat, tunisian_dialect_risk, عيب |
| hard_018 | هذا عيب؟ | risky | dangerous | 0.4..0.6 | 1.00 | tunisian_dialect_risk, عيب | threat, sexual content, tunisian_dialect_risk, عيب |
...
Dialect text-risk bump: 0.2 → 0.3 so dialect-only scores reach RISKY_THRESHOLD (0.3); 0.25 left merged risk at 0.25 (still safe).
